...
class FastFitTrainer:
    ...
    def set_trainer(self):
        metric = load_metric(self.data_args.metric_name, trust_remote_code=True, experiment_id=uuid.uuid4())
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self.training_args.device == "mps":
            from modeling import set_mps
            set_mps()
